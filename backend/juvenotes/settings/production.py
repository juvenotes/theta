...
ALLOWED_HOSTS = [os.environ['WEBSITE_HOSTNAME'], os.environ['CUSTOM_HOSTNAME'], '.juvenotes.com', os.environ['LOCAL_FRONTEND_IP']]
...
# SECURE_HSTS_SECONDS = os.environ.get("SECURE_HSTS_SECONDS", default=3600, cast=int)
...
CELERY_BROKER_URL = os.environ.get("RABBITMQ_URL", default="") or os.environ.get('AZURE_REDIS_CONNECTIONSTRING')
